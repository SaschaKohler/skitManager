        ...
        return [
            Forms\Components\Card::make()
                ->schema([
                    ...
                    Forms\Components\Fieldset::make(__('filament-breezy::default.profile.personal_info.heading'))
                        ->schema([
                            Forms\Components\TextInput::make('street')
                                ->label(__('filament-breezy::default.profile.personal_info.street'))
                                ->columnSpan(2),
                            Forms\Components\TextInput::make('plz')
                                ->label(__('filament-breezy::default.profile.personal_info.plz'))
                                ->columnSpan(1),
                            Forms\Components\TextInput::make('city')
                                ->label(__('filament-breezy::default.profile.personal_info.city'))
                                ->columnSpan(1),
